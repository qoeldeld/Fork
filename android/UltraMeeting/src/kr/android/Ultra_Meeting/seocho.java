...
public class seocho extends Activity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		public void onClick(View v) {	
			switch(v.getId()){
	        			...
	        			case R.id.m1:
	        				Intent i1 = new Intent(seocho.this, Meeting_Planner.class);
	        				startActivity(i1);
	        				break;
	        				
	        			case R.id.m2:
	        				Intent i2 = new Intent(seocho.this, seocho.class);
	        				startActivity(i2);
	        				break;
	        				
	        			case R.id.b1:
	        				Intent i3 = new Intent(seocho.this, rs4.class);
	        				startActivity(i3);
	        				break;
