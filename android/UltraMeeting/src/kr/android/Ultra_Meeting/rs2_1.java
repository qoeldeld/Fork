...
public class rs2_1 extends Activity implements OnClickListener{
																				...
																				btn4.setOnClickListener(this);
																							    		...
																							    		public void onClick(View v) {	
																												switch(v.getId()){
																																		        			...
																																		        			case R.id.m1:
																																							        				Intent i1 = new Intent(rs2_1.this, Meeting_Planner.class);
																																													        				startActivity(i1);
																																																			        				break;
																																																									        				
																																																															        			case R.id.m2:
																																																																				        				Intent i2 = new Intent(rs2_1.this, rs2.class);
																																																																										        				startActivity(i2);
																																																																																        				break;
																																																																																												        			...
																																																																																												        			case R.id.b1:
																																																																																																	        				break;
																																																																																																													        			...
																																																																																																													        			case R.id.b2:
																																																																																																																		        				Intent i4 = new Intent(rs2_1.this, rs2_1.class);
																																																																																																																								        				startActivity(i4);
																																																																																																																														        				break;
